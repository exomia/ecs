...
namespace Exomia.ECS.Events
{
    ...
    /// <typeparam name="T2"> Generic type parameter. </typeparam>
    /// <typeparam name="T3"> Generic type parameter. </typeparam>
    sealed class OHandler<T1, T2, T3>
    {
        /// <summary>
        ///     The callbacks.
        /// </summary>
        ...
        /// <summary>
        ///     Initializes static members of the <see cref="OHandler{T1,T2,T3}" /> class.
        /// </summary>
        static OHandler()
        {
        ...
        /// </summary>
        /// <param name="key"> The key. </param>
        /// <param name="o">   [out] The out <see cref="O{T1,T2,T3}" /> to process. </param>
        /// <returns>
        ///     True if it succeeds, false if it fails.
        /// </returns>
